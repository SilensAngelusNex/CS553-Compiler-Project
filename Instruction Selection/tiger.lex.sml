...
fun yyAction55 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("Illegal Tab in String (\\t should be used). Did you forget to close the string: " ^ !str);
                                                 YYBEGIN INITIAL;
                                                 Tokens.STRING(!str, yypos + 1 - String.size (!str), yypos + 1)
                                                ))
...
fun yyAction57 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (let val text = substring(yytext,1,3)
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ73(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"p"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ76(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ81(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ83(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"f"
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ91(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ95(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ97(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then if inp = #"l"
                  then yyQ93(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
              else yyAction20(strm, yyNO_MATCH)
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ98(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
              else yyAction20(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ106(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ105(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
              else yyAction20(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ104(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
...
fun yyQ43 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ111(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
...
fun yyQ115 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction22(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ115(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ22(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
              else yyAction52(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"!"
              ...
              then if inp <= #"/"
                  then yyQ9(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                  else yyQ12(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp = #"^"
