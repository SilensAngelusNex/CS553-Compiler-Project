       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ102(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
              else yyAction20(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
              else yyAction20(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ105(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
