...
struct
    ...
    val labelSet = foldl (fn (l, s) => LS.add (s, l)) LS.empty ["tig_print", "tig_flush", "tig_getchar", "tig_ord", "tig_chr", "tig_size", "tig_substring", "tig_stringEqual", "tig_concat", "tig_not", "tig_exit", "tig_initArray", "tig_allocRecord"]
